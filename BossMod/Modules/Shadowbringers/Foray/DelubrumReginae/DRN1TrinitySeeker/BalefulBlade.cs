...
class BalefulBlade(BossModule module) : BossComponent(module)
{
    ...
    private static readonly AOEShapeCone _shapeFront = new(DRN1.BarricadeRadius, 22.5f.Degrees());
    private static readonly AOEShapeDonutSector _shapeBehind = new(DRN1.BarricadeRadius, 30, 22.5f.Degrees());
    ...
    public bool IsSafe(Actor actor)
    {
        ...
        var behind = offset.LengthSq() > DRN1.BarricadeRadius * DRN1.BarricadeRadius;
